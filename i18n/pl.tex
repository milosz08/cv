...
\AddSkillEntry
  ...
  {C, CMake, ESP-IDF (FreeRTOS), ESP32/ESP32-C3 (RISC-V), MQTT (Moquette), I2C, RS-232/485, mDNS, aktualizacje OTA}
\AddSkillEntry
  {R\&D i DSP}
...
\AddSkillEntry
  {Chmura i DevOps}
  {
    Docker, GitHub Actions, Linux (Debian), Z shell, GCP, OCI, Nginx, HashiCorp Consul (magazyn KV), Prometheus,
    Grafana, Loki, K8S
  }
\AddSkillEntry
  {Bezpieczeństwo}
