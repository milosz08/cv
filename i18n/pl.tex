...
\AddSkillEntry
  {Architektura}
  {
    mikroserwisy, rozpraszanie usług stanowych, architektura heksagonalna (porty i adaptery), projektowanie API i
    bibliotek (DI, IoC, silniki oparte o adnotacje), projektowanie protokołów (TCP/UDP), wzorce projektowe, SOLID
  }
\AddSkillEntry
  {Testowanie}
